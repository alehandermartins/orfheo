...
(function(ns){
  ...
  ns.langs.ca = {
    ...
    project:{
      ...
      list2: "<p>IDENTITAT <ul><li>Creiem que cada persona és una cosa única, que és un punt en l'espai que s'uneix a aquesta comunitat aportant un tret, un matís, un color a aquesta diversitat cromàtica. </li> <li> Exercim un paper actiu en el desenvolupament d'un món liure, a on s'innova gràcies al xicotet esforç colectiu de moltes persones. </li> </ul></p>",
      list3: "<p>INFORMACIÓ <ul><li>L'accés a la informació és una eina fonamental. Ens agradaria facilitar l'accés en la major quantitat d'idiomes possibles. </li> <li> Volem que tingues accés a la informació en qualsevol lloc i en qualsevol moment. </li> <li> No volem que busques sinó que trobes en orfheo allò que esperabes trobar. </li> </ul></p>",
      list4: '<p>EXPERIÈNCIA <ul><li>Ix de la xarxa: volem donar la millor experiència possible els usuaris per damunt dels nostres propis beneficis i objectius interns, per tal que els processos siguen cada vegada més ràpids, perquè es puga viure en orfheo només el temps necessari, utilitzant la seva informació per després aplicar-la de manera pràctica en la vida quotidiana. </li> <li> Pretenem evolucionar cap a una interfie i una estètica neta, clara i senzilla, utilitzable per tots i totes. </li> </ul></p>',
      ...
      list6: "<p>VISIÓ <ul><li>Pensem que encarar un projecte ha de ser divertit i apassionant. Pensem que una cultura de treball adequada promou el talent i la creativitat.  Els èxits de l'equip i els individuals contribueixen al èxit global. Tenim una visió creativa del treball, de l'oci i de la vida. </li> <li> Totes les ideas interessants que surgeixen en els més diferents contextos es comenten, s'analitzen en profonditat i si fa falta es posen en pràctica amb dedicació. </li><li> Triem i construïm col·laborativament, perquè la nostra meta és la unitat. Prenem decisions de manera metòdica, de forma genuina i utilitzant el consens. Tenim discusions obertes, animades amb processos que porten a acords en un temps raonable. </li><li> Ens posem objectius que tal vegada no podrem abastar, perquè estem convençuts que al llarg del camí, els esforços, per complir-los, ens portaran a obtindre resultats, potser diferents dels esperats, però igualment valuosos. </li> </ul></p>",
      list7: '<p>MISSIÓ <ul><li>La nostra missió és incentivar la cultura participativa a través d\'atorgar noves possibilitats i eines dedicades a construir i millorar les relacions de col·laboració, que són la base de la cultura en què creiem. </li></ul></p>'  
    },
    manager:{
      title: 'Gestiona',
