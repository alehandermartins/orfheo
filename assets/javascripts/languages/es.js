...
(function(ns){
  ...
  ns.langs.es = {
    ...
    project:{
      ...
      list1: '<p>COMPARTIR <ul><li>Saber más de los demás significa aprender unos de otros. </li> <li> Compartimos nuestro valor donde: valor = (experiencias + conocimientos) x actitud. </li> <li> Compartimos nuestras ideas e inspiraciones creativas con el fin de crear e inspirar experiencias enriquecedoras. </li> <li> Piensa en la comunidad y la comunidad pensará en ti. </li> </ul></p>',
      list2: '<p>IDENTIDAD <ul><li>Creemos que cada persona es algo único, que es un punto en el espacio que se une a esta comunidad aportando un rasgo, un matiz, un color a esta diversidad cromática. </li> <li> Desempeñamos un papel activo en el desarrollo de un mundo más libre e inclusivo, que se crea gracias al pequeño esfuerzo colectivo de muchas personas. </li></ul></p>',
      list3: '<p>INFORMACIÓN <ul><li>El acceso a la información es una herramienta fundamental. Nos gustaría facilitar el acceso en la mayor cantidad de idiomas posibles. </li> <li> Queremos que tengas acceso a la información en cualquier lugar y en cualquier momento. </li> <li> No queremos que busques sino que encuentres en orfheo lo que esperabas encontrar. </li> </ul></p>',
      list4: '<p>EXPERIENCIA <ul><li>Sal de la red: queremos dar la mejor experiencia posible a los usuarios por encima de nuestros própios beneficios y objetivos internos, para que los procesos sean cada vez más rápidos, para que se pueda vivir en orfheo sólo el tiempo necesario, utilizando su información para luego aplicarla de manera práctica en la vida cotidiana. </li> <li> Pretendemos evolucionar hacia una interfaz y una estética limpia, clara y sencilla, utilizable por todos y todas. </li> </ul></p>',
      list5: '<p>ECONOMÍA <ul><li>Se puede ganar dinero siendo honestos, cuidando y defendiendo la comunidad. Con esta intención queremos hacer sostenible económicamente este proyecto y las vidas de quienes trabajan en ello. </li> </ul></p>',
      list6: '<p>VISIÓN <ul><li>Creemos que afrontar un proyecto debería ser divertido y apasionante. Creemos que una cultura de trabajo adecuada promueve el talento y la creatividad. Los logros del equipo, y los éxitos individuales contribuyen al éxito global. Tenemos una visión creativa del trabajo, del ocio y de la vida. </li><li> Todas las ideas interesantes que surgen en los más diferentes contextos se comentan, se analizan en profundidad y si hace falta se ponen en práctica con dedicación. </li><li> Elegimos y construimos colaborativamente, porque nuestra meta es la unidad. Tomamos decisiones de manera metódica, de forma genuina y utilizando el consenso. Tenemos discusiones abiertas, animadas por procesos que nos llevan a acuerdos en un tiempo razonable. </li><li> Nos fijamos objetivos que tal vez no podremos alcanzar, porque estamos convencidos de que a lo largo del camino, los esfuerzos, por cumplirlos, nos llevarán a obtener resultados, quizás diferentes de los esperados, pero igualmente valiosos. </li></ul></p>',
      list7: '<p>MISIÓN <ul><li>Nuestra misión es incentivar la cultura participativa a través de otorgar nuevas posibilidades y herramientas dedicadas a construir y mejorar las relaciones de colaboración, que son la base de la cultura en la que creemos. </li> </ul></p>'  
    },
    manager:{
      title: 'Gestiona',
