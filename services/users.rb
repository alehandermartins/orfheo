  ...
  class Users
    class << self
      ...
      def register params
        ...
        Services::Mails.deliver_mail_to user.to_h, :welcome if params[:event_id].blank?
        Services::Mails.deliver_mail_to user.to_h, :event, event(params[:event_id])  unless params[:event_id].blank?
